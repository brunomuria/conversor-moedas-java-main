...
![GitHub repo size](https://img.shields.io/github/repo-size/brunomuria/coonversor-moedas-java)
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/brunomuria/coonversor-moedas-java)
...
Este é um programa em Java que permite converter valores de Real brasileiro (BRL) para outras moedas, como Dólar americano (USD), Euro (EUR), Libra esterlina (GBP), Iene japonês (JPY) e Franco suíço (CHF). O programa usa a Sua chave de API: 5767fb0df228b1436da5c4b4 Exemplo de solicitação: https://v6.exchangerate-api.com/v6/5767fb0df228b1436da5c4b4/latest/USD para obter as taxas de conversão em tempo real.
...
```
git clone https://github.com/brunomuria/conversor-moedas-java.git
```
...
Este Conversor de Moedas em Java foi desenvolvido por [Bruno Muria](https://github.com/brunomuria)
